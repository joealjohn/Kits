...
public final class HikariProxyStatement extends ProxyStatement implements Wrapper, AutoCloseable, Statement {
  ...
  public String enquoteLiteral(String paramString) throws SQLException {
    try {
      return this.delegate.enquoteLiteral(paramString);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
  ...
  public String enquoteIdentifier(String paramString, boolean paramBoolean) throws SQLException {
    try {
      return this.delegate.enquoteIdentifier(paramString, paramBoolean);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
  ...
  public boolean isSimpleIdentifier(String paramString) throws SQLException {
    try {
      return this.delegate.isSimpleIdentifier(paramString);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
  ...
  public String enquoteNCharLiteral(String paramString) throws SQLException {
    try {
      return this.delegate.enquoteNCharLiteral(paramString);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
...
/* Location:              C:\Users\joeal\Downloads\Kits-2.0.9.jar!\dev\continuum\kits\libs\hikari\pool\HikariProxyStatement.class
