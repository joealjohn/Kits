...
public final class HikariProxyCallableStatement extends ProxyCallableStatement implements Wrapper, AutoCloseable, Statement, PreparedStatement, CallableStatement {
  ...
  public String enquoteLiteral(String paramString) throws SQLException {
    try {
      return ((CallableStatement)this.delegate).enquoteLiteral(paramString);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
  ...
  public String enquoteIdentifier(String paramString, boolean paramBoolean) throws SQLException {
    try {
      return ((CallableStatement)this.delegate).enquoteIdentifier(paramString, paramBoolean);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
  ...
  public boolean isSimpleIdentifier(String paramString) throws SQLException {
    try {
      return ((CallableStatement)this.delegate).isSimpleIdentifier(paramString);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
  
  public String enquoteNCharLiteral(String paramString) throws SQLException {
    try {
      return ((CallableStatement)this.delegate).enquoteNCharLiteral(paramString);
    } catch (SQLException sQLException) {
      throw checkException(sQLException);
    } 
  }
...
/* Location:              C:\Users\joeal\Downloads\Kits-2.0.9.jar!\dev\continuum\kits\libs\hikari\pool\HikariProxyCallableStatement.class
