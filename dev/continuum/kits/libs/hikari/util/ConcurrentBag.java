...
/* 340 */       if (iConcurrentBagEntry.getState() == state) {
/* 341 */         count++;
/*     */       }
/*     */     } 
/* 344 */     return count;
...
/* 351 */       states[iConcurrentBagEntry.getState()] = states[iConcurrentBagEntry.getState()] + 1;
/*     */     }
...
/*     */     try {
/* 384 */       if (System.getProperty("dev.continuum.kits.libs.hikari.useWeakReferences") != null) {
/* 385 */         return Boolean.getBoolean("dev.continuum.kits.libs.hikari.useWeakReferences");
/*     */       }
/*     */       
...
/* Location:              C:\Users\joeal\Downloads\Kits-2.0.9.jar!\dev\continuum\kits\libs\hikar\\util\ConcurrentBag.class
