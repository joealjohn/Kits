/*    */ package dev.continuum.kits.database.kit;
/*    */ 
...
/* 34 */     callback.execute(Boolean.valueOf(delete(uuid, kit)), Optional.ofNullable(Bukkit.getPlayer(uuid)));
/*    */   }
/*    */   
...
/* 40 */     callback.execute(Boolean.valueOf(save(uuid, kit, data)), Optional.ofNullable(Bukkit.getPlayer(uuid)));
/*    */   }
/*    */   
/*    */   @Nullable
...
/* Location:              C:\Users\joeal\Downloads\Kits-2.0.9.jar!\dev\continuum\kits\database\kit\KitsDatabase.class
