...
/*     */   private Menu menu;
/*     */   
/*     */   public MenuParser(@NotNull FileConfiguration configuration) {
/*  24 */     this.configuration = configuration;
/*     */   }
/*     */   @NotNull
/*     */   public static MenuParser wrap(@NotNull FileConfiguration configuration) {
/*  28 */     return new MenuParser(configuration);
/*     */   }
/*     */   
/*     */   public int size() {
...
/*  94 */       menu().button(slot, Button.button()
/*  95 */           .item(builder)
/*  96 */           .onClick(listener)); }
/*     */   
/*     */   }
...
/* 107 */       this.menu = Menu.menu(title(), size());
/*     */     }
/*     */     
...
/* Location:              C:\Users\joeal\Downloads\Kits-2.0.9.jar!\dev\continuum\kits\parser\menu\MenuParser.class
